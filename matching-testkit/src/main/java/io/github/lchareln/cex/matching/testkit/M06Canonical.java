...
final class M06Canonical {
  private M06Canonical() {}

  static Canonical fixed(M06Corpus.Fixed corpus) {
  ...
  static Canonical generated(List<M06GeneratedSuite.History> histories) {
    List<String> lines = new ArrayList<>();
    lines.add("M06H1");
    int commandCount = 0;
  ...
  static String command(M06ReferenceCommand command) {
