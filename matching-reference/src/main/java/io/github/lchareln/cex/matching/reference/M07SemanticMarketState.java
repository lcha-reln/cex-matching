...
/** Detached sequences, controls, attribution, and book after an M07 command boundary. */
public record M07SemanticMarketState(
    ...
    M07SemanticBook book) {
  public M07SemanticMarketState {
