...
/** Raw immutable M05 order-entry price-band artifact with repository-owned canonical bytes. */
public record M05MarketRuleSetArtifact(
  ...
  public M05MarketRuleSetArtifact {
  ...
  /** Creates an artifact whose claimed hash is computed from its own M05RS1 canonical bytes. */
  public static M05MarketRuleSetArtifact canonical(
  ...
  /** The frozen version-zero unbounded entry band used by every fresh M05 model. */
  public static M05MarketRuleSetArtifact bootstrap() {
  ...
  public M05RuleSetIdentity identity() {
    return new M05RuleSetIdentity(version, contentHash);
  }

  public boolean contentHashHasCanonicalShape() {
    return M05RuleSetIdentity.isCanonicalContentHash(contentHash);
  }
