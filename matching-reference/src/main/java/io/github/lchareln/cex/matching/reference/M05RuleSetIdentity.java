...
/** Content-addressed rule identity owned by the independent M05 reference model. */
public record M05RuleSetIdentity(BigInteger version, String contentHash) {
